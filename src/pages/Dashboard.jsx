...
import { Search, Grid, Star, Heart, Sparkles, Filter, SlidersHorizontal, RefreshCw, Download, ChevronLeft, ChevronRight, ExternalLink, FolderGit2, Target, Activity, Eye, ArrowRight } from 'lucide-react'
      ...
      <AnimatePresence>
        ...
        >
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 'var(--space-6)', marginBottom: 'var(--space-12)' }}>
            ...
            <GlassCard style={{ padding: 24 }}>
              ...
              <div style={{ marginTop: 8 }}>
                <a href={selectedPortfolioProject.behanceUrl} target="_blank" rel="noreferrer" style={{ color: '#fff', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6, fontSize: 14, fontWeight: 600 }}>
          ...
          <div style={{ maxWidth: 800, margin: '0 auto', textAlign: 'center', marginBottom: 'var(--space-16)' }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: 18, lineHeight: 1.6 }}>{selectedPortfolioProject.overview}</p>
          </div>

          <div style={{
            display: 'grid',
            gridTemplateColumns: selectedPortfolioProject.type === 'masonry' ? 'repeat(auto-fit, minmax(400px, 1fr))' : '1fr',
            gap: 'var(--space-6)'
          }}>
          ...
          {selectedPortfolioProject.stats && selectedPortfolioProject.stats.length > 0 && (
            <div style={{ marginTop: 'var(--space-16)' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'center', gap: 'var(--space-8)', flexWrap: 'wrap' }}>
                {selectedPortfolioProject.stats.map(s => (
